...
import 'package:hive_db/hive_login/screens/home.dart';
import 'package:hive_db/hive_login/screens/signup.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SizedBox(
        child: Stack(
          children: [
            const RiveAnimation.asset('assets/animations/planet.riv', fit: BoxFit.cover,),
            Positioned(
                top: 250,
                left: 0,
                right: 0,
